...
wget -P  ./feeds/luci/modules/luci-mod-admin-full/luasrc/view/admin_system https://git.io/JJJ7w
wget -P  ./feeds/luci/modules/luci-mod-admin-full/luasrc/controller/admin https://git.io/JJJ7o
wget -P package/lean/default-settings/files  https://git.io/JJJ7i
...
wget -P package/lean/autocore/files  https://git.io/JJJ7S
wget -P package/lean/autocore/files https://git.io/JJJ7Q
##获取额外package
echo -e "$red 同步更新最新额外插件"
rm -rf ./package/new
##beardropper
